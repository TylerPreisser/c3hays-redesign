...
export const SECTION_EXAMPLES: SectionExampleDef[] = [
  ...
  // Round-2 EDITORIAL — alternating image/text "field notes" rows (Hays & Colby
  // dispatches). Faithful port of the `.d-altrows-` mockup; every eyebrow/kicker/
  // heading/body is data-cms text, each tile is an editable data-cms-bg region.
  ...
  // Round-2 MEDIA + CARDS + navmaps library (each a faithful editor-native port).
  { id: "resourceGrid", label: "Resource Grid", icon: "LayoutGrid", group: "Cards & grids", description: "Filterable cards for sermons, articles, guides and a featured podcast.", variants: [] },
  ...
  { id: "seriesArchive", label: "Series Archive", icon: "LibraryBig", group: "Media", description: "A poster grid of your sermon series with scripture refs.", variants: [] },
  { id: "mediaCarousel", label: "Media Carousel", icon: "GalleryHorizontal", group: "Media", description: "A filterable, swipeable carousel of messages, podcasts and playlists.", variants: [] },
