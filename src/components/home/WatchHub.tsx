...
const EPISODES: EpisodeDef[] = [
  {
    key: "ep1",
    title: "Ruth: A Kinsman Redeemer",
    ref: "Ruth 4:1&ndash;12",
    panelMeta: "Pastor Jared Kessler",
    panelDur: "34:12",
    rowMeta: "Pastor Jared Kessler &middot; Hays",
    dur: "34:12",
  },
  {
    key: "ep2",
    title: "Everyday Faith: Ordinary Obedience",
    ref: "James 1:22",
    panelMeta: "Pastor Micah Doerr",
    panelDur: "29:48",
    rowMeta: "Pastor Micah Doerr &middot; Colby",
    dur: "29:48",
  },
  {
    key: "ep3",
    title: "Prodigal: The Father Who Runs",
    ref: "Luke 15:20",
    panelMeta: "Pastor Jared Kessler",
    panelDur: "41:03",
    rowMeta: "Pastor Jared Kessler &middot; Hays",
  ...
  {
    key: "ep4",
    title: "Rooted: Established in Him",
    ref: "Colossians 2:6&ndash;7",
    panelMeta: "Pastor Micah Doerr",
    panelDur: "36:15",
    rowMeta: "Pastor Micah Doerr &middot; Hays",
    dur: "36:15",
  },
  {
    key: "ep5",
    title: "Advent: Emmanuel With Us",
    ref: "Isaiah 7:14",
    panelMeta: "Pastor Jared Kessler",
    panelDur: "31:27",
    rowMeta: "Pastor Jared Kessler &middot; Colby",
    dur: "31:27",
  },
];
      ...
      <div className="whub-grid">
        ...
        <div className="whub-video" data-cms-bg="whub-watch-bg">
          ...
          <p
            ...
            dangerouslySetInnerHTML={{ __html: tx(text, "whub-video-caption", "Sunday Gathering: Rooted Wk. 3 &middot; Pastor Jared Kessler &middot; 42:18") }}
          />
        </div>
