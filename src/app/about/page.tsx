...
/**
 * /about — rebuilt to the editor-editable SECTION contract.
 *
 * Composed via <PageComposer> from FOUR editor-native sections whose ids match
 * the editor registry the queen updates:
 *   • about-hero   → inline hero JSX (about-hero-bg + eyebrow/heading/subhead)
 *   • about-story  → "Who We Are / A relationship, not religion" <Section> block
 *   • about-values → <OurValues>
 *   • about-staff  → <StaffGrid>
 *
 * PageComposer wraps each visible section in `<div data-section={id}>` and injects
 * the scoped per-section background stylesheet. Every element-level data-cms /
 * data-cms-img / data-cms-link tag is preserved byte-for-byte from the prior page.
 *
 * Server component; reads PUBLISHED CMS overrides (preview branch under CMS_LIVE).
 */
