...
export default function SermonPlayer({ text, className }: SermonPlayerProps) {
  ...
  const totalLabel = tx(text, "splayer-time-total", "38:10");
      ...
      <div className="splayer-inner">
        <div className="splayer-art" data-cms-bg="splayer-art-bg">
          ...
          <span
            ...
            dangerouslySetInnerHTML={{ __html: tx(text, "splayer-series-tag", "Series &middot; Rooted") }}
          />
          <button
            type="button"
        ...
        <div className="splayer-info">
          ...
          <h3
            ...
            dangerouslySetInnerHTML={{ __html: tx(text, "splayer-title", "Rooted and Built Up") }}
          />
          <p className="splayer-meta">
            <span
              className="splayer-speaker"
              data-cms="t:splayer-speaker"
              dangerouslySetInnerHTML={{ __html: tx(text, "splayer-speaker", "Pastor Jared Kessler") }}
            />
            <span className="splayer-dot" aria-hidden="true">&middot;</span>
            <span
              className="splayer-ref"
              data-cms="t:splayer-ref"
              dangerouslySetInnerHTML={{ __html: tx(text, "splayer-ref", "Colossians 2:6&ndash;7") }}
            />
          </p>
