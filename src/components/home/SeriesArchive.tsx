...
const SERIES: SeriesDef[] = [
  {
    key: "card1", n: 1, href: "#", title: "Series title", ref: "Scripture reference",
    count: "Message count &middot; Season", active: 6,
  ...
  {
    key: "card2", n: 2, href: "#", title: "Series title", ref: "Scripture reference",
    count: "Message count &middot; Season", active: 4,
  ...
  {
    key: "card3", n: 3, href: "#", title: "Series title", ref: "Scripture reference",
    count: "Message count &middot; Season", active: 5,
    cover: "radial-gradient(100% 100% at 70% 20%, rgba(250,247,242,.28), transparent 55%), linear-gradient(160deg,#33312c,#1b1c1c 70%)",
  },
  {
    key: "card4", n: 4, href: "#", title: "Series title", ref: "Scripture reference",
    count: "Message count &middot; Season", active: 3,
  ...
  {
    key: "card5", n: 5, href: "#", title: "Series title", ref: "Scripture reference",
    count: "Message count &middot; Season", active: 8,
    cover: "radial-gradient(100% 100% at 50% 0%, rgba(28,195,175,.6), transparent 55%), linear-gradient(160deg,#12201f,#1b1c1c 70%)",
  },
  {
    key: "card6", n: 6, href: "#", title: "Series title", ref: "Scripture reference",
    count: "Message count &middot; Season", active: 4,
...
export default function SeriesArchive({ text, className }: SeriesArchiveProps) {
  ...
  const heading = tx(text, "sarchive-heading", "Sermon series");
