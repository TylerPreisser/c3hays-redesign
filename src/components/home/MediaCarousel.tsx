 ...
 * an eyebrow + heading, a row of filter tabs (All / Audio / Video / Playlist),
...
type Kind = "audio" | "video" | "playlist";
  ...
  return (
    ...
    >
      <style>{`
        ...
        .mcarousel-card--audio .mcarousel-badge{background:var(--color-teal);color:var(--color-ink)}
      ...
      <div className="mcarousel-head">
        <div>
          ...
          <h3
            ...
            dangerouslySetInnerHTML={{ __html: tx(text, "mcarousel-heading", "Messages &amp; media") }}
          />
        </div>
