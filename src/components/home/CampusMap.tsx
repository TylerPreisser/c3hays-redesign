...
const CAMPUSES: Campus[] = [
  {
    id: "hays",
    tag: "Hays &mdash; Main Campus",
    sub: "Main Campus",
    title: "C3 Church &mdash; Hays",
    left: "76%",
    top: "38%",
    rows: [
      { field: "address", icon: "pin", label: "Address", value: "5790 230th Ave, Hays, KS 67601 &mdash; just off I-70" },
      { field: "times", icon: "clock", label: "Sundays", value: "9:00am &amp; 10:45am &middot; Wednesdays 6:30pm, C3 Students" },
      { field: "parking", icon: "car", label: "Parking", value: "Front lot fills first &mdash; the gravel overflow lot has room, and a greeter in a vest will wave you in on busy Sundays" },
    ],
  },
  {
    id: "colby",
    tag: "Colby &mdash; West Campus",
    sub: "West Campus",
    title: "C3 Church &mdash; Colby",
    left: "18%",
    top: "68%",
    rows: [
      { field: "address", icon: "pin", label: "Address", value: "Just off the I-70 exit into Colby, KS 67701" },
      { field: "times", icon: "clock", label: "Sundays", value: "10:00am, one gathering" },
      { field: "parking", icon: "car", label: "Parking", value: "West lot, right off the frontage road &mdash; no overflow needed, plenty of room" },
    ],
  },
];
...
export default function CampusMap({ text, className }: CampusMapProps) {
  ...
  return (
    ...
    >
      <style>{`
        .campusmap-root{--campusmap-gap:clamp(1.5rem,3vw,3rem)}
        ...
        .campusmap-wrap{position:relative;display:grid;grid-template-columns:1.5fr 1fr;gap:var(--campusmap-gap);align-items:stretch}
        @media (max-width:860px){.campusmap-wrap{grid-template-columns:1fr}}

        .campusmap-mapbox{position:relative;border-radius:1.1rem;overflow:hidden;border:1px solid rgba(250,247,242,.12);background:linear-gradient(160deg,#12302c 0%,var(--color-ink) 62%);min-height:380px}
        ...
        .campusmap-cards{position:relative;display:flex;flex-direction:column}
