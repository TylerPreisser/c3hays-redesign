...
const ROWS: RowDef[] = [
  {
    ...
    kicker: "Hays, Kansas &mdash; Sundays at 9 &amp; 10:45",
    heading: "The Room Fills Slow, Then All At Once",
    body: "Ten minutes before the first song, the lobby is mostly empty &mdash; a few families claiming seats, someone restocking the coffee urn. By 9:04 it&rsquo;s standing room only. &ldquo;We built this room for exactly this,&rdquo; says Pastor Daniel Voss, &ldquo;a place that fills because people keep choosing to show up for each other.&rdquo;",
  },
  {
    key: "row2", art: "grass", rev: true,
    kicker: "Colby, Kansas &mdash; Wednesday nights",
    heading: "Twelve Chairs In A Living Room On 5th Street",
    body: "Home groups in Colby don&rsquo;t meet behind a sign out front &mdash; they meet in living rooms, in the fellowship hall&rsquo;s side kitchen, in a garage with a space heater running through February. Romans 12:13 says to practice hospitality, and out here that&rsquo;s mostly literal: an extra chair, a full pot of coffee, a door already unlocked before anyone knocks.",
  },
  {
    key: "row3", art: "river", rev: false,
    kicker: "The Saline River, east of Hays",
    heading: "Baptisms Happen Where The Water Still Runs",
    body: "Three Saturdays a year, C3 drives twenty minutes east to a bend in the Saline River where the bank slopes gentle enough to wade in. No baptistery, no stage lighting &mdash; just cold water, a line of people waiting their turn, and Romans 6:4 read aloud before the first person goes under: buried with him, raised to walk in newness of life.",
  },
];

export default function EditorialRows({ text, className }: EditorialRowsProps) {
  const eyebrow = tx(text, "editorial-eyebrow", "Field Notes &mdash; C3 Church");
