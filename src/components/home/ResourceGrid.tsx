...
/**
 * ResourceGrid — an addable "resources" card grid (sermons / articles / podcast /
 ...
 * chips, then a grid with one large featured/podcast card (2×2, animated audio
...
const CARDS: CardDef[] = [
  {
    ...
    title: "When You Can&rsquo;t See the Next Step",
    sub: "A message from the Rooted series.",
    foot: "Watch &middot; 41 min", arrow: "&rarr;", href: "/messages/",
  },
  {
    key: "card2", k: "article", tag: "Article",
    title: "Five Ways to Actually Read Your Bible",
    sub: "Practical habits that stick past January.",
    foot: "Read &middot; 6 min", arrow: "&rarr;", href: "/articles/",
  },
  {
    key: "card3", k: "guide", tag: "Download",
    title: "New Believer&rsquo;s Guide (PDF)",
    sub: "Everything for your first 30 days of faith.",
    foot: "Download &middot; 2.4 MB", arrow: "&darr;", href: "/downloads/",
  },
  {
    key: "card4", k: "guide", tag: "Guide",
    title: "Family Devotions for the Kitchen Table",
    sub: "Four weeks, five minutes a night.",
    foot: "Download &middot; 1.1 MB", arrow: "&darr;", href: "/downloads/",
  },
];
        ...
        <div className="resgrid-grid">
          {showFeatured && (
            <a
              ...
              href={text?.["resource-feat-href"] || "/podcast/"}
            ...
            >
              ...
              <div className="resgrid-featbody">
                <span
                  ...
                  dangerouslySetInnerHTML={{ __html: tx(text, "resource-feat-kind", "Podcast &middot; Latest Episode") }}
                />
                <h3
                  data-cms="t:resource-feat-title"
                  dangerouslySetInnerHTML={{ __html: tx(text, "resource-feat-title", "The Table &mdash; Faith for the Long Haul") }}
                />
                <p
                  ...
                  dangerouslySetInnerHTML={{
                    __html: tx(
                      text,
                      "resource-feat-body",
                      "Pastor Daniel and the team unpack what it looks like to stay faithful when the season is quiet. New episodes every Tuesday.",
                    ),
                  }}
                />
                <span className="resgrid-meta">
                  <span className="resgrid-dot" aria-hidden="true" />
                  <span data-cms-link-label>{text?.["resource-feat-label"] || "38 min · Ep. 42"}</span>
                </span>
              </div>
            </a>
          )}
